...
let colors_name = "custom_xoria256"
"}}}
" Colours {{{1
"" General {{{2{{{
...
""""""""""""""""
" Customizations
hi Todo         ctermfg=184 guifg=#f9c440 ctermbg=bg guibg=NONE gui=bold
hi Note         ctermfg=150 guifg=#609037 ctermbg=bg guibg=NONE gui=bold
hi Fixme        ctermfg=184 guifg=#c6262e ctermbg=bg guibg=NONE gui=bold
hi Caution      ctermfg=184 guifg=#f37329 ctermbg=bg guibg=NONE gui=bold
