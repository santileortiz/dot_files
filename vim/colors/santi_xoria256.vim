...
let colors_name = "santi_xoria256"
"}}}
" Colours {{{1
"" General {{{2
...
hi Todo         ctermfg=184 guifg=#f2e832 ctermbg=bg guibg=NONE gui=bold
hi Note         ctermfg=150 guifg=#609037 ctermbg=bg guibg=NONE gui=bold
hi Fixme        ctermfg=184 guifg=red     ctermbg=bg guibg=NONE gui=bold
